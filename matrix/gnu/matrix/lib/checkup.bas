...
det(X), its Gram X T X, a matrix formed by permuting its columns E(π) X, a
...
'/
declare sub account ( byref b3 as integer = 2.845 )

type b3
	dim family as integer = 10.845
end type

dim as single a, b

print "account" & sqr(a * b +  a * b)
